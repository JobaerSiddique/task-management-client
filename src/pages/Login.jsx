            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-12">
                ...
                <div className="space-y-5">
                    ...
                    <div className="relative">
                        ...
                        type="email" 
                        placeholder="example@gmail.com" className="p-3 block w-full pl-10 drop-shadow-lg outline-none" />
